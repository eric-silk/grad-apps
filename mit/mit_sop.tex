...
Every individual I've had the pleasure of interacting with that was an alumni or faculty member
has demonstrated a clear ability to dissect complex problems into well-abstracted, intuitive
components with tractable solutions and far-reaching impacts. I want to emulate this, and
the best way to do so is to surround myself with folks who can challenge me, and
who I can in turn challenge and help to grow. I cannot understate the import of the domain
in which I work --- electric power is the lifeblood of modern living. As such, only the best
tools and training, along with the best network of collaborators, will do in tackling its
challenges. The world needs experts capable of guiding discourse, policy, technology
and education to ensure equitable, economical, and reliable access to power. Your institution
is doubtless the best to serve these needs.

I want to also note that the opportunities afforded by the Lincoln Lab are akin to my current
application space. Few other programs offer such a unique avenue for research
